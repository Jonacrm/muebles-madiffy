                    ...
                    <div class="p-6">
                        ...
                        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div>
                                ...
                                <input type="date" id="fecha_emision" value="{{ now()->toDateString() }}" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" disabled>
                            </div>
                            ...
                            <div x-data="{ days: '{{ old('validity_days', $cotizacion['validity_days']) }}', base: '{{ now()->toDateString() }}', expires() { const date = new Date(`${this.base}T00:00:00`); date.setDate(date.getDate() + Number(this.days)); return date.toISOString().slice(0, 10); } }">
                                ...
                                <p class="mt-1 text-xs text-gray-500">Caduca el <span x-text="expires()"></span></p>
                            </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-indigo-500">Estado inicial</label>
                                <input type="hidden" name="status" value="borrador">
                                <div class="mt-1 rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-gray-700">Borrador</div>
                            </div>
